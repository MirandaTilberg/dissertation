...
<<main-setup, echo = FALSE, include = FALSE>>=
library(knitr)
...
<<knit-chs, results = "hide">>=
knitr::knit("./Body/ch1_main.Rnw", output = "./Body/ch1_main.tex", quiet = TRUE)
knitr::knit("./Body/ch2_main.Rnw", output = "./Body/ch2_main.tex", quiet = TRUE)
knitr::knit("./Body/ch3_main.Rnw", output = "./Body/ch3_main.tex", quiet = TRUE)
knitr::knit("./Body/ch4_main.Rnw", output = "./Body/ch4_main.tex", quiet = TRUE)
knitr::knit("./Body/ch5_main.Rnw", output = "./Body/ch5_main.tex", quiet = TRUE)
knitr::knit("./Body/ch6_future_and_conclusions.Rnw", 
            output = "./Body/ch6_future_and_conclusions.tex", quiet = TRUE)
@
